...
const IMAGE_POOLS = {
  pontos: {
    default: [
      ...
      buildImageUrl('photo-1501785888041-af3ef285b470'),
      buildImageUrl('photo-1500530855697-b586d89ba3ee'),
    ],
    park: [
    ...
    museum: [
      ...
      buildImageUrl('photo-1486607607790-8f5a79f1c8ef'),
      buildImageUrl('photo-1514587891085-54f56e56b1ce'),
    ],
    historic: [
...
function pickFromPool(pool, seed, ordinal = 0) {
  ...
  const index = hashString(`${seed}:${ordinal}`) % pool.length;
  return pool[index];
}
